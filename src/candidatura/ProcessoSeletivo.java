...
public class ProcessoSeletivo {
    ...
    static void entrandoContato(String candidato) {
        ...
        if(atendeu)
            ...
            System.out.println("NÃO CONSEGUIMOS ENTRAR EM CONTATO COM " + candidato + " NÚMERO MÁXIMO DE TENTATIVAS " + tentativasRealizadas + " REALIZADA ");
    }
    ...
    static void analisarCandidato(double salarioPretendido) {
        ...
        if(salarioBase > salarioPretendido) {
            ...
            System.out.println("LIGAR PARA O CANDIDATO CONTRA A PROPOSTA");
        }else 
